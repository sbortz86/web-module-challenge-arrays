...
function addFlavor(arrayFlavor, newFlavor){

    originalFlavors.unshift (newFlavor);
    console.log("Original Flavors: ", originalFlavors);
}
...
function removeLastFlavor(arrayFlavor, removeFlavor){

    originalFlavors.pop (removeFlavor);
    console.log("Original Flavors: ", originalFlavors);
...
function removeFlavorByName(flavorArray, removeFlavors)
{

    for (let i = 0; i < flavorArray.length; i++) 
    {
        if ( flavorArray[i] === removeFlavors )
        {
...
function copy( arrayDestination, arraySource )
{

    arrayDestination = arraySource.slice(0); 
